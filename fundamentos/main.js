...
const carToogle= document.querySelector('.car__toggle');
const carBlock = document.querySelector('.car__block');
// dibujar en la web los productos
const productList = document.querySelector('#products_container');
 //carrito
 const car= document.querySelector('#car');
 const car_List = document.querySelector('#car__list');
 let carProducts =[];
...
products.forEach(element => {
  html += `<div class ="product_container">
             ...
             <div class ="product_container_name" alt="name">
              <p>${element.name}</p>
             </div>
             <div class = "product_container_price" alt="price">
